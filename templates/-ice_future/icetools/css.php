...
<link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/styles/style.php?default=<?php echo $TemplateStyle; ?>.css" />

<?php  if ($this->params->get('responsive_template')) { ?>
<!-- Template Styles -->
<link rel="stylesheet" type="text/css" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/styles/style.php?default=<?php echo $TemplateStyle; ?>_responsive.css" />
