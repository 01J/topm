...
<div class="rs_sliderprodv">
			...
			<div class="pochemu">
				...
				<div class="clr"></div>
				<div class="pochemu4">
					<jdoc:include type="modules" name="pochemu4" style="xhtml" />
				</div>
				<div class="clr"></div>
            </div>
			<div class="example">
				<jdoc:include type="modules" name="example" style="xhtml" />
				<div class="example1">
			...
			<div class="doverie">
				<jdoc:include type="modules" name="doverie" style="xhtml" />
				<div class="doverie1">
					<jdoc:include type="modules" name="doverie1" style="xhtml" />
				</div>
				<div class="doverie2">
					<jdoc:include type="modules" name="doverie2" style="xhtml" />
				</div>
				<div class="doverie3">
					<jdoc:include type="modules" name="doverie3" style="xhtml" />
				</div>
			...
			<div class="otzyvy">
				...
				<jdoc:include type="modules" name="otzyvy" style="xhtml" />
				<div class="mihail">
					<jdoc:include type="modules" name="mihail" style="xhtml" />
				</div>
				<div class="clr"></div>
			...
			<div class="ouraim">
				...
				<jdoc:include type="modules" name="ouraim" style="xhtml" />
				<div class="konkurprodv">
				
				<div class="formcontainerprodv">
				<div class="formaprodv">
			<div class="formanameprodv1"><p>Оставьте заявку на продвижение в поисковых системах сегодня и начните получать новых клиентов уже через месяц!</p>
			<jdoc:include type="modules" name="formaaim" style="xhtml" />
			<div class="audit"><jdoc:include type="modules" name="audit" style="xhtml" /></div>
			</div>
			...
			<div class="uznai">
				...
				<jdoc:include type="modules" name="uznai" style="xhtml" />
